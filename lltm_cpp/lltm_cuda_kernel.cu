...
std::vector<torch::Tensor> lltm_cuda_forward(torch::Tensor input,
  ...
  AT_DISPATCH_FLOATING_TYPES(
      gates.scalar_type(), "lltm_forward_cuda", ([&] {
...
lltm_cuda_backward(torch::Tensor grad_h, torch::Tensor grad_cell,
  ...
  AT_DISPATCH_FLOATING_TYPES(
      X.scalar_type(), "lltm_backward_cuda", ([&] {
